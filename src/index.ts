...
const tokens = [
  ...
  { name: 'stEth',   fetchFn: () => defaultFetch({ tokens: ['0x1f32b1c2345538c0c6f582fcb022739c4a194ebb', '0x6c76971f98945ae98dd7d4dfca8711ebea946ea6', '0x5d8cff95d7a57c0bf50b30b43c7cc0d52825d4a9', '0xae7ab96520de3a18e5e111b5eaab095312d7fe84', '0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0', '0x03b54a6e9a984069379fae1a4fc4dbae93b3bccd', '0x5979d7b546e38e414f7e9822514be443a4800529', '0xc1cba3fcea344f92d9239c08c0568f6f2f0ee452'], url: 'https://eth-api.lido.fi/v1/protocol/steth/apr/sma', path: 'data.smaApr' }) },
  { name: 'pufETH',   fetchFn: () => defaultFetch({ tokens: ['0xd9a442856c234a39a81a089c06451ebaa4306a72'], url: 'https://eth-api.lido.fi/v1/protocol/steth/apr/sma', path: 'data.smaApr' }) },
  ...
  { name: 'rETH',    fetchFn: () => defaultFetch({ tokens: ['0x9bcef72be871e61ed4fbbc7630889bee758eb81d', '0xb23c20efce6e24acca0cef9b7b7aa196b84ec942', '0xae78736cd615f374d3085123a210448e74fc6393', '0xec70dcb4a1efa46b8f2d97c310c9c4790ba5ffa8, 0xc791240d1f2def5938e2031364ff4ed887133c3d'], url: 'https://api.rocketpool.net/api/apr', path: 'yearlyAPR' }) },
  { name: 'sfrxETH', fetchFn: () => defaultFetch({ tokens: ['0x1f55a02a049033e3419a8e2975cf3f572f4e6e9a', '0x484c2d6e3cdd945a8b2df735e079178c1036578c', '0xac3e018457b222d93114458476f3e3416abbe38f', '0x95ab45875cffdba1e5f451b950bc2e42c0053f39', '0xfc00000000000000000000000000000000000005'], url: 'https://api.frax.finance/v2/frxeth/summary/latest', path: 'sfrxethApr' }) },
  ...
  { name: 'sFRAX', fetchFn: () => defaultFetch({ tokens: ['0xa663b02cf0a4b149d2ad41910cb81e23e1c41c32', '0xe3b3fe7bca19ca77ad877a5bebab186becfad906', '0x2dd1b4d4548accea497050619965f91f78b3b532', '0xfc00000000000000000000000000000000000008'], url: 'https://api.frax.finance/v2/frax/sfrax/summary/history?range=1d', path: 'items.0.sfraxApr', scale: 100 }) },
  ...
  { name: 'rsETH', fetchFn: () => defaultFetch({ tokens: ['0xa1290d69c65a6fe4df752f95823fae25cb99e5a7', '0x8c7d118b5c47a5bcbd47cc51789558b98dad17c5', '0x87eee96d50fb761ad85b1c982d28a042169d61b1'], url: 'https://universe.kelpdao.xyz/rseth/apy', path: 'value', scale: 100 }) },
