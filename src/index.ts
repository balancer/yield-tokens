...
const tokens = [
  ...
  { name: 'sfrxETH', fetchFn: () => defaultFetch({ tokens: ['0x1f55a02a049033e3419a8e2975cf3f572f4e6e9a', '0x484c2d6e3cdd945a8b2df735e079178c1036578c', '0xac3e018457b222d93114458476f3e3416abbe38f', '0x95ab45875cffdba1e5f451b950bc2e42c0053f39'], url: 'https://api.frax.finance/v2/frxeth/summary/latest', path: 'sfrxethApr' }) },
